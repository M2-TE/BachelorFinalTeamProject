...
{
    private QuadMesh[] quads = {        //Front, Back, Left, Right, Up, Down
        new QuadMesh(new Vector3[] // Front
        {
            vertices[1],
            vertices[3],
            vertices[5],
        ...
        new int[]{0,2,1,
                  1,2,3,}),
        new QuadMesh(new Vector3[] // Right
        {
            vertices[0],
            vertices[1],
            vertices[4],
